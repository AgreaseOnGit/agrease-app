...
object SellerDummyDataSource {
    val dummyProducts = listOf(
        ...
        ProductModel(
            "6",
            "Wortel Berastagi Baby Konvensional 500 gram Panda Farm",
            "Tersedia dalam pilihan konvensional dan imperfect. Wortel imperfect memiliki ukuran yang beragam, agak berlubang, bercabang 2-3, dan lebih kecil. Namun rasa dan nutrisinya tetap sama.\n" +
                    ...
                    "Di Panda Farm, kami selalu berusaha menjaga kualitas produk hasil pertanian yang kami sediakan untuk dikirim kepada konsumen kami. Namun, apabila Anda mengalami kendala dari produk yang Anda terima dari Panda Farm, mohon untuk mengklik 'KOMPLAIN PESANAN' agar dapat segera kami proses. \n" +
                    "\n" +
                    "Untuk klaim terkait dengan produk Panda Farm hanya untuk barang yang rusak akibat pengantaran atau terdapat barang yang tidak terkirim, maka dari itu kami memerlukan beberapa informasi berikut ini: \n" +
                    "1. Foto dari produk yang Anda terima dari Panda Farm sebagai bukti \n" +
                    ...
                    "\n" +
                    "Jika ada pertanyaan, silahkan menghubungi kami lewat pesan pribadi di akun Tokopedia Panda Farm ya SayurFriends. \n" +
        ...
        ProductModel(
            "8",
            "Pisang (Banana) Cavendish (500gr) Panda Farm",
        ...
        ProductModel(
            "10",
            "Mangga Harum Manis (1kg) Panda Farm",
